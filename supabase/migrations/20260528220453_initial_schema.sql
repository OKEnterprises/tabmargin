...
CREATE INDEX "notes_user_updated_idx" ON "public"."notes" USING "btree" ("user_id", "updated_at" DESC) WHERE ("deleted_at" IS NULL);
...
CREATE POLICY "users select own subscription" ON "public"."subscriptions" FOR SELECT USING (("auth"."uid"() = "user_id"));
